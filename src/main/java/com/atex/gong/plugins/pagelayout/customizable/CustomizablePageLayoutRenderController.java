package com.atex.gong.plugins.pagelayout.customizable;
...
public class CustomizablePageLayoutRenderController extends RenderControllerBase {

    private static final Logger LOGGER = Logger.getLogger(CustomizablePageLayoutRenderController.class.getName());
